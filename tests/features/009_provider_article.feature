Feature: Use article provider
  ...
  Scenario: Given an article XML, parse it and return some values
    ...
    And I have the article article_title <article_title>
    
  Examples:
    | env | tmp_base_dir  | test_name         | document_name	                      | doi                  | doi_id  | doi_url                               | lens_url                            | tweet_url                                                                            | pub_date_timestamp | article_title
    | dev | tmp           | article_provider  | test_data/elife00013.xml            | 10.7554/eLife.00013  | 00013   | http://dx.doi.org/10.7554/eLife.00013 | http://lens.elifesciences.org/00013 | http://twitter.com/intent/tweet?text=http%3A%2F%2Fdx.doi.org%2F10.7554%2FeLife.00013 | 1350259200         | A bacterial sulfonolipid triggers multicellular development in the closest living relatives of animals
    | dev | tmp           | article_provider2 | test_data/elife_2013_00415.xml.zip  | 10.7554/eLife.00415  | 00415   | http://dx.doi.org/10.7554/eLife.00415 | http://lens.elifesciences.org/00415 | http://twitter.com/intent/tweet?text=http%3A%2F%2Fdx.doi.org%2F10.7554%2FeLife.00415 | 1366070400         | Ovulation in Drosophila is controlled by secretory cells of the female reproductive tract
