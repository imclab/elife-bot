...
@step('I have the article article_title (.+)')
def i_have_the_article_article_title(step, article_title):
  assert world.article.article_title == article_title, \
  "Got article_title %s" % world.article.article_title 
